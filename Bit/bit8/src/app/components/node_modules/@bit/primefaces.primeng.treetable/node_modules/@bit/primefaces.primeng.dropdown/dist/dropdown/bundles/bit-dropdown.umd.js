(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/scrolling'), require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('@bit/primefaces.primeng.internal.common.shared'), require('@bit/primefaces.primeng.internal.dom'), require('@bit/primefaces.primeng.utils'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@bit/primefaces.primeng.dropdown', ['exports', '@angular/cdk/scrolling', '@angular/core', '@angular/animations', '@angular/common', '@bit/primefaces.primeng.internal.common.shared', '@bit/primefaces.primeng.internal.dom', '@bit/primefaces.primeng.utils', '@angular/forms'], factory) :
    (global = global || self, factory((global.bit = global.bit || {}, global.bit.dropdown = {}), global.ng.cdk.scrolling, global.ng.core, global.ng.animations, global.ng.common, global.internal_common_shared, global.internal_dom, global.utils, global.ng.forms));
}(this, function (exports, scrolling, core, animations, common, internal_common_shared, internal_dom, utils, forms) { 'use strict';
    ...
    var Dropdown = /** @class */ (function () {
        ...
        function () {
            ...
            if (this.selectedOptionUpdated && this.itemsWrapper) {
                /** @type {?} */
                var selectedItem = internal_dom.DomHandler.findSingle(this.overlay, 'li.ui-state-highlight');
                if (selectedItem) {
                    internal_dom.DomHandler.scrollInView(this.itemsWrapper, internal_dom.DomHandler.findSingle(this.overlay, 'li.ui-state-highlight'));
                }
        ...
        function (event) {
            ...
            this.selfClick = true;
            this.clearClick = internal_dom.DomHandler.hasClass(event.target, 'ui-dropdown-clear-icon');
        ...
        function (event) {
            switch (event.toState) {
                case 'visible':
                    ...
                    this.itemsWrapper = internal_dom.DomHandler.findSingle(this.overlay, '.ui-dropdown-items-wrapper');
                    this.appendOverlay();
                    if (this.autoZIndex) {
                        this.overlay.style.zIndex = String(this.baseZIndex + (++internal_dom.DomHandler.zindex));
                    }
                    this.alignOverlay();
                    this.bindDocumentClickListener();
                    ...
                    if (this.options && this.options.length) {
                        if (!this.virtualScroll) {
                            /** @type {?} */
                            var selectedListItem = internal_dom.DomHandler.findSingle(this.itemsWrapper, '.ui-dropdown-item.ui-state-highlight');
                            if (selectedListItem) {
                                internal_dom.DomHandler.scrollInView(this.itemsWrapper, selectedListItem);
                            }
                        }
                    }
                    if (this.filterViewChild && this.filterViewChild.nativeElement) {
        ...
        function () {
            if (this.appendTo) {
                if (this.appendTo === 'body')
                    ...
                    internal_dom.DomHandler.appendChild(this.overlay, this.appendTo);
                this.overlay.style.minWidth = internal_dom.DomHandler.getWidth(this.containerViewChild.nativeElement) + 'px';
            }
        };
        /**
         * @return {?}
        ...
        function () {
            if (this.overlay) {
                if (this.appendTo)
                    internal_dom.DomHandler.absolutePosition(this.overlay, this.containerViewChild.nativeElement);
                else
                    internal_dom.DomHandler.relativePosition(this.overlay, this.containerViewChild.nativeElement);
            }
        };
        /**
         * @param {?} event
                ...
                if (this.group) {
                    ...
                    try {
                        for (var _b = __values(this.options), _c = _b.next(); !_c.done; _c = _b.next()) {
                            ...
                            /** @type {?} */
                            var filteredSubOptions = utils.ObjectUtils.filter(optgroup.items, searchFields, this.filterValue);
                    ...
                    this.optionsToDisplay = utils.ObjectUtils.filter(this.options, searchFields, this.filterValue);
                }
                this.optionsChanged = true;
            }
        };
        ...
        function () {
            if (this.editable)
                internal_dom.DomHandler.findSingle(this.el.nativeElement, '.ui-dropdown-label.ui-inputtext').focus();
            else
                internal_dom.DomHandler.findSingle(this.el.nativeElement, 'input[readonly]').focus();
        };
        /**
         * @return {?}
         */
         ...
         */
        function () {
            if (!internal_dom.DomHandler.isAndroid()) {
                this.hide();
            }
        };
        /**
        ...
        Dropdown.propDecorators = {
            ...
            filterViewChild: [{ type: core.ViewChild, args: ['filter', { static: false },] }],
            focusViewChild: [{ type: core.ViewChild, args: ['in', { static: false },] }],
            viewPort: [{ type: core.ViewChild, args: [scrolling.CdkVirtualScrollViewport, { static: false },] }],
            editableInputViewChild: [{ type: core.ViewChild, args: ['editableInput', { static: false },] }],
            templates: [{ type: core.ContentChildren, args: [internal_common_shared.PrimeTemplate,] }],
    ...
    var DropdownModule = /** @class */ (function () {
        ...
        DropdownModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, internal_common_shared.SharedModule, scrolling.ScrollingModule],
                        exports: [Dropdown, internal_common_shared.SharedModule, scrolling.ScrollingModule],
...
//# sourceMappingURL=bit-dropdown.umd.js.map
