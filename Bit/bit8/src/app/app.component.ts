...
import {MatDivider, MatCard, MatIconRegistry} from '@angular/material';
...
export class AppComponent implements OnInit {
  ...
  imgOptions1: any;
  imgOptions2: any;
  @ViewChild('info', {static:true}) info: InfoIconComponent;
...
@Component({
  ...
  template: '<mat-icon svgIcon="info" aria-hidden="false" aria-label="info"></mat-icon>'
})
export class InfoIconComponent {
  constructor(iconRegistry: MatIconRegistry, sanitizer: DomSanitizer) {
    iconRegistry.addSvgIcon(
        'info',
        sanitizer.bypassSecurityTrustResourceUrl('assets/img/examples/info.svg'));
  }
}